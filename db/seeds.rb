...
the_louvre.photo.attach(io: file_vg, filename: 'the_louvre.jpg', content_type: 'image/jpg')
the_louvre.save
...
eiffel_tower.photo.attach(io: file_vg, filename: 'eiffel_tower.jpg', content_type: 'image/jpg')
eiffel_tower.save
...
virgin_mary.photo.attach(io: file_vg, filename: 'virgin_mary.jpg', content_type: 'image/jpg')
virgin_mary.save
...
central_park.photo.attach(io: file_vg, filename: 'central_park.jpg', content_type: 'image/jpg')
central_park.save
...
yellow_stone.photo.attach(io: file_vg, filename: 'yellow_stone.jpg', content_type: 'image/jpg')
yellow_stone.save
...
buckingham_palace.photo.attach(io: file_vg, filename: 'buckingham_palace.jpg', content_type: 'image/jpg')
...
palace_versailles.photo.attach(io: file_vg, filename: 'palace_versailles.jpg', content_type: 'image/jpg')
...
taj_mahal.photo.attach(io: file_vg, filename: 'taj_mahal.jpg', content_type: 'image/jpg')
taj_mahal.save
...
cristo_redentor.photo.attach(io: file_vg, filename: 'cristo_redentor.jpg', content_type: 'image/jpg')
